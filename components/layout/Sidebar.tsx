...
import { LayoutDashboard, Server, FolderOpen, Database, CreditCard, LogOut, FileText, Activity, Users, User as UserIcon, Globe, ShoppingBag, Terminal, ShieldCheck, X, MessageSquare, Network, Settings, BookOpen, Cloud, Bell } from 'lucide-react';
      ...
      <nav className="px-4 space-y-2 mt-4 overflow-y-auto h-[calc(100vh-140px)] custom-scrollbar">
        {user.role === UserRole.USER ? (
          ...
          <>
            ...
            <NavItem view="ADMIN_NOTIFICATIONS" icon={Bell} label="Notification Settings" />
