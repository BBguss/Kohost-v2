...
export const SAFE_COMMANDS: Record<string, TerminalAction[]> = {
  [Framework.LARAVEL]: [
    ...
    { id: 'cache_clear', label: 'Clear Cache', command: 'php artisan cache:clear', description: 'Flush the application cache', isDangerous: false, executionMode: 'local' },
    { id: 'route_list', label: 'Route List', command: 'php artisan route:list', description: 'List all registered routes', isDangerous: false, executionMode: 'local' },
