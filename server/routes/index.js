...
router.post('/auth/verify-email', authController.verifyRegisterEmail); // New
router.post('/auth/reset-init', authController.initiateReset); // New
router.post('/auth/reset-confirm', authController.confirmReset); // New
...
router.post('/admin/users', adminController.createUser); // Added missing create user route
router.delete('/admin/users/:userId', adminController.deleteUser); // Added missing delete user route
...
router.put('/admin/payments/:id/verify', adminController.verifyPayment);

// Admin Settings
router.get('/admin/settings/notifications', settingsController.getNotificationSettings);
router.put('/admin/settings/notifications', settingsController.updateNotificationSettings);
...
router.put('/plans/:id', async (req, res) => { res.json({success: true}); }); // Mock update
router.delete('/plans/:id', async (req, res) => { res.json({success: true}); }); // Mock delete
